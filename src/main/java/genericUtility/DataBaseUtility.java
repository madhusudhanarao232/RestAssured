...
//			PASSWORD = fLib.getDataFromProperties(filepath, "password");
		URL=Iconstants.dURL;
		USERNAME=Iconstants.dUserName;
		PASSWORD=Iconstants.dpassword;
	 ...
	 * @throws Throwable
	 */
	public String executeQuerryAndVerify(String query,int cloumnIndex,String expectedData) throws Throwable {
		boolean flag=false;
		result=connection.createStatement().executeQuery(query);
		while(result.next()) {
